...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  var map = new mapboxgl.Map({
    container: 'map',
    // here will put the mapbox in container called 'map' in our html
    //  in our case tour.pug has this '#map(data-locations.....'
    style: 'mapbox://styles/guarito47/cmcmsm2sy00en01s002ov4q3j',
    // style URL
    scrollZoom: false
...
var hideAlert = exports.hideAlert = function hideAlert() {
  var el = document.querySelector('.alert'); //the <div class="alert class name to find the alert
  if (el)
    //if we found it the alert
...
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /**as this file is javascript and not node js we call export(javascript) and not exports (nodejs) */
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { if (r) i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n;else { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } o("next", 0), o("throw", 1), o("return", 2); } }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } //this is es6 syntax(client side) and not the common js syntax that we use in nodejs
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(data, type) {
    var url, res, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          _context2.p = 0;
          url = type === 'password' //here we switch the api method
          ? 'http://127.0.0.1:3000/api/v1/users/updateMyPassword' : 'http://127.0.0.1:3000/api/v1/users/updateMe';
          _context2.n = 1;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
            data: data //the data we receive is a object like {name, email} or {passwordCurrent, password, passwordConfirm}
          });
        case 1:
          res = _context2.v;
          if (res.data.status === 'success') {
...
var stripe = Stripe('pk_test_51RjVjZ2NumaGHjgnZPxIbxIFvZzr6HpCastTw55j9onocFrsVYhQAyKhK8uDt92p8ZbaESklJlQbZne9E583ZIjK00w0uyo7kX');
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { if (r) i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n;else { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } o("next", 0), o("throw", 1), o("return", 2); } }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } //this file is more to get data from the interface, an then delegate the actions
...
var mapBox = document.getElementById('map'); //only available for the tour page
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; //you ca use destructuring as well, const {tourId} = e.target.dataset;
    (0, _stripe.bookTour)(tourId); //call the bookTour function with the tour ID
  });
}
