...
/*   res.status(404).json({
 ...
 /*  const error= new Error(`cant find ${req.originalUrl} on this server v2`);
  ...
  //don forget the fail field will be generated based on the number we pass here
...
//as soon express detetcs this middleware where it has a error first and then req, res, next
//automatically klnow that you are defining an kind of global error midleware
