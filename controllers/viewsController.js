...
exports.alerts=  (req, res, next)=>{
  ...
  if(alert==='booking')
    res.local.alert = "Your booking was successful, please check your email for a confirmation. If your booking doesn't shop up here inmediatly, please come back later"; 
  next();
};
